...
![image](./assets/init-project/1740465674009-r6fksi55.png)
...
![image](./assets/init-project/1740465674140-clkgisgs.png)
...
![image](./assets/init-project/1740465674250-2ykr44hu.png)
...
![image](./assets/init-project/1740465674347-4bgbnqhm.png)
...
![image](./assets/init-project/1740465674465-hqg9y6po.png)
...
![image](./assets/init-project/1740465674568-merp240h.png)

上图可以看到，lint 校验没通过，无法 commit，此时再把 `const a = 1;` 删除掉，消除 eslint 的报错，再次执行 commit

![image](./assets/init-project/1740465674709-qnpa4a7t.png)

上图可知，这次代码的校验已经通过，但是 commitlint 抛出了错误，提示 commit 信息不规范，此时修改一下再提交

![image](./assets/init-project/1740465674833-qpi6bask.png)
