...
![命令使用及运行示例](./assets/ssl-cert/1740465681628-wk6i3ut8.png)
...
![指引](./assets/ssl-cert/1740465681767-2lod5iny.png)

自己的服务器用 AccessKey 也可以，简单方便，用子账户的话还需要手动授予权限（前提是能分辨那些该分配那些不该分配）。

![阿里云配置 Security](./assets/ssl-cert/1740465681911-f52u27y4.png)
...
![输出路径](./assets/ssl-cert/1740465682047-hepi4qap.png)
...
![上传证书位置](./assets/ssl-cert/1740465682193-p5p6yvte.png)
