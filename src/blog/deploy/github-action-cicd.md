...
> 该文章的 Shell 脚本部分过于冗余，若需要看更简约更直观的，可查看 [Github Action 实现 CI CD 自动化部署](/posts/deploy/docker-env-install#github-action-实现-ci-cd-自动化部署)
...
![secret key 设置](./assets/github-action-cicd/1740465678450-mpx1tyhi.png)
...
![命令示例](./assets/github-action-cicd/1740465678612-8gk8zqnt.png)

## 提交代码

此时提交代码就可以触发 GitHub Action 了。失败的话会有邮箱提示，详细信息可以查看 Action 控制台日志。

![cicd 成功示例](./assets/github-action-cicd/1740465678809-g33pqm6k.png)

### SSL 证书

证书相关请查看 [免费无限续期 SSL 证书](/posts/deploy/ssl-cert)
