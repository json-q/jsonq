...
![unknown 类型](./assets/project-config-problem/1740465682936-gy1vypwy.png)
...
![类型提示](./assets/project-config-problem/1740465683056-c7ogtsn7.png)

## 使用 ESlint 报错 'module' is not defined

![错误示例](./assets/project-config-problem/1740465683197-2z5r0zln.png)
