...
1. **创建路由实例**  
   ![创建路由实例](./assets/vue-router-vuex/1740465701055-q0d9p8gh.jpeg)
2. **在 `main.js` 中使用 路由实例**  
   ![使用路由实例](./assets/vue-router-vuex/1740465701169-mpwkmfnt.jpeg)
3. **使用 `<router-link>` 设置跳转链接。使用 `<router-view>` 设置路由组件的渲染位置**  
   ![router组件渲染](./assets/vue-router-vuex/1740465701279-k8l6rek7.jpeg)
...
1. **使用动态路由**  
   ![动态路由](./assets/vue-router-vuex/1740465701406-37d92lil.jpeg)
2. **获取动态路由的值**
...
![参数打印](./assets/vue-router-vuex/1740465701515-cqghyu1q.jpeg)
...
![Vuex数据流程图](./assets/vue-router-vuex/1740465701632-qgepiy9o.png)
...
![mapState映射](./assets/vue-router-vuex/1740465701727-g7pduqnr.jpeg)
...
![computed直接使用mapState解构](./assets/vue-router-vuex/1740465701822-3ugq3d9q.jpeg)

原因是，`name、age` 函数是通过 `this.$store.state` 进行访问数据，而 **setup 中没有 this**

![name函数](./assets/vue-router-vuex/1740465701934-126bhh6e.jpeg)
...
![bind绑定this](./assets/vue-router-vuex/1740465702038-loevcm7i.jpeg)
...
![pinia基本使用](./assets/vue-router-vuex/1740465702137-n008zm7f.jpeg)
...
4. 替换 State
   ...
   **`$state`问题说明**：虽然官方说是替换 state，但实际结果却并非如此
   ...
   ![$state问题说明](./assets/vue-router-vuex/1740465702238-lqf4vi9i.jpeg)
