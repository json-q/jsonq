...
> 由于组件化特殊，需采用 `vue cli` 创建项目。如何安装 Vue cli 请见[初识 Vue3](/posts/vue/basic/vue-know#如何使用-vue)
...
3. 在其它组件中使用
   - ![代码](./assets/vue-components/1740465695457-eau6u8he.jpg)
   - ![结果](./assets/vue-components/1740475764100-91lezxpn.jpg)
...
1. 什么是非 Prop 的 Attribute 呢？当我们**传递给一个组件某个属性**，但是该属性并**没有定义对应的 `props` 或者 `emits` 时**，就称之为 **非 Prop 的 Attribute**；常见的包括 `class、style、id` 属性等；
   ...
   ![结果](./assets/vue-components/1740465695589-cmhb9iv1.jpg)
...
3. 指定某个节点继承`attribute` 若要指定某个节点继承父组件的非 props 的 `attribute`，可以使用 **`$attrs` 来访问所有的 非 props 的 `attribute` 属性**
...
![自定义事件校验失败](./assets/vue-components/1740465695717-nggk0s4o.jpg)
...
![provide inject流程](./assets/vue-components/1740465695810-6g9c0ghd.jpg)

##### Provide 函数写法

如果`Provide`中提供的一些数据是来自 data，那么我们可能会想要通过 this 来获取

![函数写法](./assets/vue-components/1740465695937-dh1o2cgq.jpg)
...
![非响应式provide数据](./assets/vue-components/1740465696059-cxgioz4d.jpg)

解决方法：使用`computed`

![computed响应式数据](./assets/vue-components/1740475764958-85uqkizf.jpg)
...
![slot基本使用](./assets/vue-components/1740465696173-t1q9e547.jpg)

#### 默认插槽内容

![默认插槽内容](./assets/vue-components/1740475765112-oqa503qy.jpg)
...
![具名插槽](./assets/vue-components/1740465696273-2x3nzhdl.jpg)
...
![动态插槽名](./assets/vue-components/1740465696401-ogx9ybs6.jpg)
...
![结果](./assets/vue-components/1740465696523-ehwkzqp9.jpg)
...
![作用域插槽](./assets/vue-components/1740465696637-p43oc1dp.jpg)
...
![生命周期流程图](./assets/vue-components/1740465696741-6wssgq2g.jpg)
...
![父子组件挂载阶段](./assets/vue-components/1740465696868-gd0r8ha9.jpg)

父子组件更新阶段

![父子组件更新阶段](./assets/vue-components/1740475765934-nfxwsw78.jpg)

父子组件卸载阶段

![父子组件卸载阶段](./assets/vue-components/1740465696981-rl6x23wd.jpg)
...
![结果](./assets/vue-components/1740465697085-s1oudz47.jpg)
...
2. `include` 只有名称匹配的组件会被缓存，写法：`string | RegExp | Array<string>`
   ...
   ![include写法](./assets/vue-components/1740465697210-3ki0ttwx.jpg)
...
![组件v-model实现](./assets/vue-components/1740465697306-7bayyeu0.jpg)
...
![mixins基本使用](./assets/vue-components/1740465697427-o1bm32hc.jpg)
