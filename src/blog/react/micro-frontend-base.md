...
![image](./assets/micro-frontend-base/1740465691680-4573lov0.png)
...
![image](./assets/micro-frontend-base/1740465691797-a74iwugr.png)

当匹配到主应用路由时，只会渲染主应用的路由，当主应用切换到子应用路由时，才会挂载子应用路由，简单示例图如下

![image](./assets/micro-frontend-base/1740465691933-3p6981dd.gif)

其中 ` <Route path="*" element={<></>} />` 是为了控制台不报警告加上的，不然主应用在切换到子应用时，其自身匹配不到这个路由，就会一直报警告，例如

![image](./assets/micro-frontend-base/1740465692315-qqolwhc3.png)

`/micro-app1` 并不在主应用路由之内，匹配的是微应用项目，就会报警告

美化版的主子应用路由切换

![image](./assets/micro-frontend-base/1740465692468-2ckz17gv.gif)
...
![image](./assets/micro-frontend-base/1740465692644-s0bfxcoo.png)
...
![image](./assets/micro-frontend-base/1740465692755-vw42mla7.png)
...
![image](./assets/micro-frontend-base/1740465692992-s2bpndca.gif)
