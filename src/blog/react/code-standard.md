...
![eslint 校验](./assets/code-standard/1740465689712-lgds5v4x.png)
...
![prettier 集成到 eslint](./assets/code-standard/1740465689805-mvs86mbz.png)
...
![验证 stylelint 工作](./assets/code-standard/1740465689909-tmv21g2p.png)
...
![stylelint 排序校验](./assets/code-standard/1740465690004-ho45s89u.png)
...
![autoprefixer 用处](./assets/code-standard/1740465690097-bqptkwbt.png)
...
![npx 手动初始化](./assets/code-standard/1740465690197-inknzxzh.png)

git 拉取下来安装时自带 .git 文件，会自动执行 `postinstall` 命令进行初始化

![自动初始化](./assets/code-standard/1740465690297-gg4gsof4.png)
...
![eslint错误检测](./assets/code-standard/1740465690406-xbkgqa9z.png)

eslint 执行通过之后开始执行 stylelint 校验

![stylelint错误检测](./assets/code-standard/1740465690535-chi7nohc.png)

`commit-msg` 校验提交的信息是否符合规范

![错误的提交信息](./assets/code-standard/1740465690664-mkvhhob6.png)

以上提交信息故意写错，使校验不通过，由此可见 `commit-msg` 生效了，然后改成例子中那样就可以正常提交了

![正确的提交信息](./assets/code-standard/1740465690783-v8u8b0nq.png)
...
![编码问题](./assets/code-standard/1740465690920-6yg7fka4.png)
...
![lf编码格式](./assets/code-standard/1740465691082-r66vxen5.png)
...
![别名](./assets/code-standard/1740465691176-pcrkh1qm.png)
...
![image](./assets/code-standard/1740465691271-87ysuvv4.png)

### index.html 标题使用 env 配置

vite 本身都支持在 html 中读取 env 的环境变量，以下是官方文档的描述

![image](./assets/code-standard/1740465691384-4nfxxrvp.png)
...
![项目目录](./assets/code-standard/1740465691537-8mt7sxe1.png)
