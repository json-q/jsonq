...
![image](./assets/minio-base-api/1740465685775-ubylgh3d.png)
...
![image](./assets/minio-base-api/1740465685877-laibrbal.png)
...
![image](./assets/minio-base-api/1740465685992-vgfb6v4d.png)
...
![image](./assets/minio-base-api/1740465686127-dff2kwoz.png)

此时再向该桶 `public-readonly-file` 中上传文件 `uploadObject`，然后使用 `getPresignedObjectUrl` 获取图片访问地址

![image](./assets/minio-base-api/1740465686236-23ipftqu.png)
