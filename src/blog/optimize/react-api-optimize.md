...
![image](./assets/react-api-optimize/1740465688016-h2tuhwqc.png)

效果图：

![image](./assets/react-api-optimize/1740476995624-l09dxd1q.gif)
...
![image](./assets/react-api-optimize/1740465688157-nhrorb9e.png)

效果图：

![image](./assets/react-api-optimize/1740476995743-5hh6l5q0.gif)
...
![image](./assets/react-api-optimize/1740465688245-m8lve545.gif)
...
![image](./assets/react-api-optimize/1740465688359-ug8x9vxv.png)
...
![image](./assets/react-api-optimize/1740465688445-khbicxq5.png)
...
![image](./assets/react-api-optimize/1740465688784-6ui29nns.png)

效果图：

![image](./assets/react-api-optimize/1740476995829-8p69rv5d.gif)
...
![image](./assets/react-api-optimize/1740465688881-sh04f07a.png)

更改父组件的 `timestamp`，其中 `getList` 函数跟 `timestamp` 半毛钱关系没有，就算子组件加了 `memo` 和 深对比，也无法阻止 rerender

![image](./assets/react-api-optimize/1740465688977-h8f6fq7y.gif)
...
![image](./assets/react-api-optimize/1740465689120-l54rsibg.png)

效果图：

![image](./assets/react-api-optimize/1740476995960-cebv5f8i.gif)
...
![image](./assets/react-api-optimize/1740465689224-sh3l1b7z.png)
...
![image](./assets/react-api-optimize/1740465689356-k6taeudx.png)

![image](./assets/react-api-optimize/1740476996069-evstla4a.gif)
...
![image](./assets/react-api-optimize/1740465689486-wfzytqao.png)

![image](./assets/react-api-optimize/1740476996148-ggmav6yd.gif)
